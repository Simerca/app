  ...
  <transition @after-leave="afterLeave">
    <div class="actionsheet-overlay" v-if="showModal" @click="deactivate">
      <div class="actionsheet">
        <div class="actionsheet-group" v-for="(group, groupIndex) in groups" :key="groupIndex">
          <div v-for="(button, index) in group" :key="index" @click.stop.prevent="onClick(button, index, groupIndex)" :class="{'actionsheet-label': button.label, 'actionsheet-button': !button.label, 'actionsheet-button-color': button.color, 'actionsheet-button-bold': button.bold, 'actionsheet-button-disable': button.disable}">{{ button.text }}</div>
        </div>
      </div>
    </div>
  </transition>
